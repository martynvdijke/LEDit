...
func (_c *LogEntryCreate) SetLevel(v string) *LogEntryCreate {
	_c.mutation.SetLevel(v)
	return _c
}

// SetSource sets the "source" field.
func (_c *LogEntryCreate) SetSource(v string) *LogEntryCreate {
...
func (_c *LogEntryCreate) SetMetadata(v string) *LogEntryCreate {
	_c.mutation.SetMetadata(v)
	return _c
}

// SetNillableMetadata sets the "metadata" field if the given value is not nil.
func (_c *LogEntryCreate) SetNillableMetadata(v *string) *LogEntryCreate {
	if v != nil {
		_c.SetMetadata(*v)
	}
	return _c
...
func (_c *LogEntryCreate) SetID(v int) *LogEntryCreate {
	_c.mutation.SetID(v)
	return _c
}
...
func (_c *LogEntryCreate) check() error {
	...
	if _, ok := _c.mutation.Source(); !ok {
		return &ValidationError{Name: "source", err: errors.New(`ent: missing required field "LogEntry.source"`)}
	}

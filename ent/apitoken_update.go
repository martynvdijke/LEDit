...
func (_u *ApiTokenUpdate) SetOwnerID(v int) *ApiTokenUpdate {
...
func (_u *ApiTokenUpdate) SetNillableOwnerID(v *int) *ApiTokenUpdate {
	if v != nil {
		_u.SetOwnerID(*v)
	}
	return _u
...
func (_u *ApiTokenUpdate) AddOwnerID(v int) *ApiTokenUpdate {
...
func (_u *ApiTokenUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.AddedOwnerID(); ok {
		_spec.AddField(apitoken.FieldOwnerID, field.TypeInt, value)
	}
...
// SetOwnerID sets the "owner_id" field.
func (_u *ApiTokenUpdateOne) SetOwnerID(v int) *ApiTokenUpdateOne {
	_u.mutation.ResetOwnerID()
	_u.mutation.SetOwnerID(v)
	return _u
}
...
// SetNillableOwnerID sets the "owner_id" field if the given value is not nil.
func (_u *ApiTokenUpdateOne) SetNillableOwnerID(v *int) *ApiTokenUpdateOne {
	if v != nil {
		_u.SetOwnerID(*v)
	}
	return _u
...
// AddOwnerID adds value to the "owner_id" field.
func (_u *ApiTokenUpdateOne) AddOwnerID(v int) *ApiTokenUpdateOne {
	_u.mutation.AddOwnerID(v)
	return _u
}

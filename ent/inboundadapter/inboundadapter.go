...
const (
	// Label holds the string label denoting the inboundadapter type in the database.
	Label = "inbound_adapter"
	...
	// Table holds the table name of the inboundadapter in the database.
	Table = "inbound_adapters"
)

// Columns holds all SQL columns for inboundadapter fields.
var Columns = []string{
	FieldID,
	FieldKind,
	FieldEnabled,
...
var (
	...
	// DefaultAllowlist holds the default value on creation for the "allowlist" field.
...
// OrderOption defines the ordering options for the InboundAdapter queries.

...
const (
	// Label holds the string label denoting the immich type in the database.
	Label = "immich"
	...
	FieldConfig = "config"
	// Table holds the table name of the immich in the database.
	Table = "immiches"
)

// Columns holds all SQL columns for immich fields.
var Columns = []string{
	FieldID,
	FieldToken,
	FieldURL,
...
// ForeignKeys holds the SQL foreign-keys that are owned by the "immiches"
// table and are not defined as standalone fields in the schema.
var ForeignKeys = []string{
	"general_settings_immichs",
}
...
// OrderOption defines the ordering options for the Immich queries.
